...
import { optionNamesOptions, suboptions } from "../../../utilis/optionNamesOptions";
...
const FormList = ({form}: {form: FormInstance}) => {
    ...
    const handleDelete = (index: number) => {
        ...
        form.setFieldValue(['options', index, 'optionName'], selectOptions[index+1]);
    };
        ...
        {(fields, { add, remove }) => (
            ...
            {fields.map(({ key, name, ...restField }, index) => (
                ...
                >
                    ...
                    <Select value={form.getFieldValue([name, "optionName"])} defaultValue={selectOptions[index]} options={optionNamesOptions} placeholder='Ընտրել հատկությունը' onChange={(value) => {
