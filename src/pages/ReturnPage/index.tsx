    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="text-center mb-4">
                <h2 className="text-xl font-bold text-gray-800">Select the returnable items</h2>
                <p className="text-red-800">The items listed here are eligible for return. The remaining items in your order are not eligible for return.</p>
            </div>
            <div className="space-y-4">
                ...
                )) : <p className="text-gray-500 text-sm">No returnable items available.</p>}
            </div>
            <hr />
            {
                returnItems.length > 0 &&
                <div>
                    <button className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700" onClick={() => handleConfirmReturn()}>
                        Confirm Return
                    </button>
                    <p className="text-red-800">You will receive the refund once the seller receives the product and confirms the return.</p>
                </div>
            }
        </div>
    );
