    ...
    return (
        <div className="max-w-2xl mx-auto p-8 bg-white rounded-2xl shadow-lg">
            ...
            <Form
                form={form}
                layout="vertical"
                onFinish={(values) => handleAddProduct({ values, userData, imageUrls, navigate })}
                className="space-y-6"
            >
                <Form.Item
                    name="name"
                    rules={[{ required: true, message: "Խնդրում ենք մուտքագրել ապրանքի անունը" }]}
                >
                ...
                <Form.Item
                    name="price"
                    label="Գին (դրամ)"
                    rules={[{ required: true, message: "Խնդրում ենք մուտքագրել գինը" }]}
                >
                    <Input
                        min={0}
                ...
                <Form.Item
                    ...
                    rules={[{ required: true, message: "Խնդրում ենք մուտքագրել նկարագրությունը։" }]}
                >
                    <Input.TextArea
                        rows={4}
                        className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                ...
                <div className="grid grid-cols-2 gap-4">
                    <Form.Item
                        name="category"
                        label="Կատեգորիա"
                        rules={[{ required: true, message: "Խնդրում ենք մուտքագրել կատեգորիան" }]}
                    >
                    ...
                    <Form.Item
                        name="subCategory"
                        label="Ենթակատեգորիա"
                        rules={[{ required: true, message: "Խնդրում ենք մուտքագրել ենթակատեգորիան" }]}
                    >
                ...
                <Form.Item
                    name="usedType"
                    label="Ապրանքի վիճակը"
                    rules={[{ required: true, message: "Խնդրում ենք ընտրել տարբերակը" }]}
                >
                ...
                <Form.Item
                    name="returnType"
                    label="Ապրանքի վերադարձի ենթակա լինելը։"
                    rules={[{ required: true, message: "Խնդրում ենք ընտրել տարբերակը" }]}
                >
                ...
                <Form.Item
                    name="stock"
                    label="Պահեստում առկա քանակ"
                    rules={[{ required: true, message: "Խնդրում ենք մուտքագրել քանակը" }]}
                >
                    <Input
                        type="number"
                        min={0}
